//https://www.google.com/recaptcha/api/js/recaptcha.js beautified
...
var RecaptchaStr_en = {
    ...
    RecaptchaStr_nl = {
        ...
        instructions_context: "",
        instructions_audio: "Typ de acht cijfers:",
        help_btn: "Help",
...
var RecaptchaStr = RecaptchaStr_en,
    ...
    Recaptcha = {
        ...
        create: function (a, b, c) {
            Recaptcha.destroy();
            if (b) Recaptcha.widget = Recaptcha.$(b);
        ...
        destroy: function () {
            ...
            Recaptcha.timer_id != -1 && clearInterval(Recaptcha.timer_id);
            Recaptcha.timer_id = -1;
            if (a = Recaptcha.$("recaptcha_image")) a.innerHTML = "";
            if (Recaptcha.widget) Recaptcha.theme != "custom" ? Recaptcha.widget.innerHTML = "" : Recaptcha.widget.style.display = "none", Recaptcha.widget = null
        },
        focus_response_field: function () {
            var a = Recaptcha.$,
                a = a("recaptcha_response_field");
            a.focus()
        },
        get_challenge: function () {
            return typeof RecaptchaState == "undefined" ? null : RecaptchaState.challenge
        },
        ...
        ajax_verify: function (a) {
            ...
            a = Recaptcha._get_api_server() + "/ajaxverify?c=" + encodeURIComponent(Recaptcha.get_challenge()) + "&response=" + encodeURIComponent(Recaptcha.get_response());
        ...
        _get_api_server: function () {
            var a = window.location.protocol,
                b;
            b = typeof _RecaptchaOverrideApiServer != "undefined" ? _RecaptchaOverrideApiServer : "www.google.com/recaptcha/api";
            return a + "//" + b
        },
        _call_challenge: function (a) {
            a = Recaptcha._get_api_server() + "/challenge?k=" + a + "&ajax=1&cachestop=" + Math.random();
            RecaptchaOptions.lang && (a += "&lang=" + RecaptchaOptions.lang);
            typeof RecaptchaOptions.extra_challenge_params != "undefined" && (a += "&" + RecaptchaOptions.extra_challenge_params);
        ...
        _set_style: function (a) {
            if (!Recaptcha.style_set) Recaptcha.style_set = !0, Recaptcha._add_css(a + "\n\n.recaptcha_is_showing_audio .recaptcha_only_if_image,.recaptcha_isnot_showing_audio .recaptcha_only_if_audio,.recaptcha_had_incorrect_sol .recaptcha_only_if_no_incorrect_sol,.recaptcha_nothad_incorrect_sol .recaptcha_only_if_incorrect_sol{display:none !important}")
        },
        _init_builtin_theme: function () {
            ...
            var f = c + "/img/" + Recaptcha.theme;
            Recaptcha.theme == "clean" ? (c = RecaptchaTemplates.CleanCss, d = RecaptchaTemplates.CleanHtml, e = "png") : (Recaptcha.theme == "context" ? (c = RecaptchaTemplates.VertCss, d = RecaptchaTemplates.ContextHtml) : (c = RecaptchaTemplates.VertCss, d = RecaptchaTemplates.VertHtml), e = "gif");
            c = c.replace(/IMGROOT/g, f);
            Recaptcha._set_style(c);
            Recaptcha.widget.innerHTML = "<div id='recaptcha_area'>" + d + "</div>";
            a("recaptcha_reload").src = f + "/refresh." + e;
            a("recaptcha_switch_audio").src = f + "/audio." + e;
            a("recaptcha_switch_img").src = f + "/text." + e;
            a("recaptcha_whatsthis").src = f + "/help." + e;
            if (Recaptcha.theme == "clean") a("recaptcha_logo").src = f + "/logo." + e, a("recaptcha_tagline").src = f + "/tagline." + e;
            a("recaptcha_reload").alt = b.refresh_btn;
            a("recaptcha_switch_audio").alt = b.audio_challenge;
            a("recaptcha_switch_img").alt = b.visual_challenge;
            a("recaptcha_whatsthis").alt = b.help_btn;
            a("recaptcha_reload_btn").href = "javascript:Recaptcha.reload ();";
            a("recaptcha_reload_btn").title = b.refresh_btn;
            a("recaptcha_switch_audio_btn").href = "javascript:Recaptcha.switch_type('audio');";
            a("recaptcha_switch_audio_btn").title = b.audio_challenge;
            a("recaptcha_switch_img_btn").href = "javascript:Recaptcha.switch_type('image');";
            a("recaptcha_switch_img_btn").title = b.visual_challenge;
            a("recaptcha_whatsthis_btn").href = Recaptcha._get_help_link();
            a("recaptcha_whatsthis_btn").target = "_blank";
            a("recaptcha_whatsthis_btn").title = b.help_btn;
            a("recaptcha_whatsthis_btn").onclick = function () {
                Recaptcha.showhelp();
                return !1
            };
            a("recaptcha_table").className = "recaptchatable recaptcha_theme_" + Recaptcha.theme;
            a("recaptcha_instructions_image") && a("recaptcha_instructions_image").appendChild(document.createTextNode(b.instructions_visual));
            a("recaptcha_instructions_context") && a("recaptcha_instructions_context").appendChild(document.createTextNode(b.instructions_context));
            a("recaptcha_instructions_audio") && a("recaptcha_instructions_audio").appendChild(document.createTextNode(b.instructions_audio));
            a("recaptcha_instructions_error") && a("recaptcha_instructions_error").appendChild(document.createTextNode(b.incorrect_try_again))
        },
        _finish_widget: function () {
            ...
            if (c.tabindex && (a("recaptcha_response_field").tabIndex = c.tabindex, Recaptcha.theme != "custom")) a("recaptcha_whatsthis_btn").tabIndex = c.tabindex, a("recaptcha_switch_img_btn").tabIndex = c.tabindex, a("recaptcha_switch_audio_btn").tabIndex = c.tabindex, a("recaptcha_reload_btn").tabIndex = c.tabindex;
        ...
        switch_type: function (a) {
            var b = Recaptcha;
            b.type = a;
            b.reload(b.type == "audio" ? "a" : "v")
        },
        reload: function (a) {
            var b = Recaptcha,
                c = RecaptchaState;
            typeof a == "undefined" && (a = "r");
            c = c.server + "reload?c=" + c.challenge + "&k=" + c.site + "&reason=" + a + "&type=" + b.type;
            RecaptchaOptions.lang && (c += "&lang=" + RecaptchaOptions.lang);
            RecaptchaOptions.includeContext && (c += "&includeContext=1");
            typeof RecaptchaOptions.extra_challenge_params != "undefined" && (c += "&" + RecaptchaOptions.extra_challenge_params);
            b.type == "audio" && (c += RecaptchaOptions.audio_beta_12_08 ? "&audio_beta_12_08=1" : "&new_audio_default=1");
            b.should_focus = a != "t";
            b._add_script(c)
        },
        ...
        _set_challenge: function (a, b) {
            ...
            d.challenge = a;
            c.type = b;
            e("recaptcha_challenge_field_holder").innerHTML = "<input type='hidden' name='recaptcha_challenge_field' id='recaptcha_challenge_field' value='" + d.challenge + "'/>";
            if (b == "audio") e("recaptcha_image").innerHTML = Recaptcha.getAudioCaptchaHtml();
            else if (b == "image") {
                var f = d.server + "image?c=" + d.challenge;
                e("recaptcha_image").innerHTML = "<img style='display:block;' height='57' width='300' src='" + f + "'/>"
            }
            Recaptcha._css_toggle("recaptcha_had_incorrect_sol", "recaptcha_nothad_incorrect_sol", d.is_incorrect);
            Recaptcha._css_toggle("recaptcha_is_showing_audio", "recaptcha_isnot_showing_audio", b == "audio");
            c._clear_input();
            c.should_focus && c.focus_response_field();
            c._reset_timer()
        },
        ...
        _get_help_link: function () {
            var a = RecaptchaState,
                a = "http://www.google.com/recaptcha/help?c=" + a.challenge;
            RecaptchaOptions.lang && (a += "&lang=" + RecaptchaOptions.lang);
            return a
        },
        playAgain: function () {
        ...
        getAudioCaptchaHtml: function () {
            var a = Recaptcha,
                b = RecaptchaState,
                c = b.server + "image?c=" + b.challenge;
        ...
        gethttpwavurl: function () {
            var a = RecaptchaState;
            return Recaptcha.type == "audio" ? (a = a.server + "image?c=" + a.challenge, a.indexOf("https://") == 0 && (a = "http://" + a.substring(8)), a) : ""
        },
